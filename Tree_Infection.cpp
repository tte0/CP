...
mt19937 mt(clock());
///////////////////////////////////////////////////////////////////
int n,m,r,k,t,q,a,b,x,y,w,ans,s,sz[N];
vi v,p,adj[N];

inline int dfs(int node=0){
    sz[node]=1;
    for(int i:adj[node])sz[node]+=dfs(i);
    return sz[node];
}
